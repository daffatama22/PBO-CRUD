...
public class jenis_barang extends javax.swing.JFrame {
    ...
    private void tambah_data() {
        ...
        try {
            ...
            String sql = "SELECT * FROM jenis_barang ORDER BY kd_jenis DESC";
    ...
    private void simpan() {
        ...
        try {
            st = con.createStatement();
            String sqlSimpan = "insert into jenis_barang values (NULL,'"+JenisJC+"','"+HargaJC+"') ";
    ...
    private void hapus_data() {
            ...
            st = con.createStatement();
            String sqlUpdate = "DELETE FROM jenis_barang WHERE kd_jenis='"+id+"'";
    ...
    private void ubah_data() {
        ...
        try {
            ...
            st = con.createStatement();
            String sqlUpdate = "UPDATE jenis_barang SET kd_jenis='"+IDJC+"',jenis_barang='"+JenisJC+"',harga='"+HargaJC+"' WHERE kd_jenis='"+id+"' ";
            st.executeUpdate(sqlUpdate);
    ...
    private void tampil_tabel() {
        try {
                st = con.createStatement();
                ResultSet rs = st.executeQuery("SELECT * FROM jenis_barang");
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Form Jenis Service", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        id_jc.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        id_jc.setText("Auto Generate");
        ...
        tambah_jc.setFont(new java.awt.Font("Maiandra GD", 1, 11)); // NOI18N
        ...
        simpan_jc.setFont(new java.awt.Font("Maiandra GD", 1, 11)); // NOI18N
        ...
        hapus_jc.setFont(new java.awt.Font("Maiandra GD", 1, 11)); // NOI18N
        ...
        ubah_jc.setFont(new java.awt.Font("Maiandra GD", 1, 11)); // NOI18N
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE, false)
                    ...
                    .addComponent(simpan_jc)
                    .addComponent(hapus_jc, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(tambah_jc))
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Tabel Service", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        jPanel3.getAccessibleContext().setAccessibleName("Form Jenis Barang");
